...
- **05-Jinn-Unseen** — *Ancient Manuscripts — Jinn, Spirits & the Unseen*. Verbatim: the complete **Holy Qur'an** (114 surahs, Uthmani + Pickthall); **Ṣaḥīḥ al-Bukhārī** and **Ṣaḥīḥ Muslim** (full hadith, Arabic); **Sunan Abū Dāwūd** and **Sunan al-Nasāʾī** (further hadith, Arabic); **Tafsīr Ibn Kathīr** (full exegesis, 21.8 MB Arabic); **Muʿjam al-Buldān** (Yāqūt); Ibn ʿArabī's *Futūḥāt al-Makkiyya* (ar). Pointers: the remaining Hadith collections, the great *tafsīr*s (al-Ṭabarī, al-Qurṭubī), *Shams al-Maʿārif*, *Picatrix*, *Ajāʾib* literature, *Kitāb al-Aghānī*, and *Nujūm al-ʿUlūm* (1571) — none with a free complete authentic PD edition located.
- **06-Medicine** — *Ancient Manuscripts — Medicine & Healing*. Verbatim: the **Hippocratic Corpus**; Galen's *On the Natural Faculties*; Culpeper's *Complete Herbal*; the **Huangdi Neijing** (黄帝內經, classical Chinese). Pointers: Avicenna's *Canon*, al-Rāzī's *al-Ḥāwī*, the Ebers & Edwin Smith papyri.
